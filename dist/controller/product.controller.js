...
let ProductController = class ProductController {
    ...
    async removeProduct(productDto) {
        return await this.productService.createNewProduct(productDto);
    }
    async getProductsByPublisherID(publisherId) {
...
__decorate([
    (0, common_1.Get)('/publisher/:publisherId'),
    __param(0, (0, common_1.Param)('publisherId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ProductController.prototype, "getProductsByPublisherID", null);
